...
var number;
   ...
   for(i=1; i<3; i++){ document.image_rotate.src = myimages[number];
     ...
     if (number > 3) number=1;
             ...
             <img name="image_rotate" src="../../images/verologo00.png" onLoad="setTimeout('animate()', delay);" alt="verologo" />
                    ...
                    <nav class="main-nav">
                       <ul> <li><a class="active" href=".">Record Sheet</a></li>
  ...
  <thead>
    <tr>
      ...
      <td scope="col">1st Test(20)</td>
	  <td scope="col">2nd Test(20)</td>
	  <td scope="col">Exam(60)</td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php htmlout($student['regnumber']); ?></td>
      <td><?php htmlout($student['surname'].' '.$student['firstname'].' '.$student['othername']); ?></td>
      <td></td>
      <td></td>
	  <td></td>
	  <td></td>
