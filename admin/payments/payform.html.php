   ...
   for(i=1; i<3; i++){ document.image_rotate.src = myimages[number];
    ...
    <form action=?<?php htmlout($action); ?> method="post" >
	 ...
	 <div class="row">
      ...
      <label for="validationDefault07">Pay Name:</label>
      <input type="text" name="name" class="form-control" id="validationDefault07" value="<?php htmlout($name); ?>" placeholder="Name" required>
    </div>
	   <div class="col-md-6 mb-6">
      <label for="validationDefault07">Amount:</label>
      <input type="text" name="amount" class="form-control" id="validationDefault07" value="<?php htmlout($amount); ?>" placeholder="Amount" required>
    </div>
