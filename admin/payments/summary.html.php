     ...
     if (number > 3) number=1;
        ...
        <div id='printarea'>  
            <?php if (count($cart) > 0): ?>
					...
					<h4>Student Official Summary of Payment</h4>
               <div class="pull-left">
                     <h5><?php
                    echo ' Student Name: ';
...
<td></td>
  ...
  <tbody>
    ...
    <tr>
      <td><?php htmlout($report['description']); ?></td>
      <td><?php htmlout($report['amountdue']); ?></td>
      <td><?php htmlout($report['total']); ?></td>
	  <td><?php htmlout($report['balance']); ?></td>
	</tr>
      <?php  endforeach; ?>
         </tbody>
       </table>
