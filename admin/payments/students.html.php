...
var number;
  ...
  function animate(){
   ...
   for(i=1; i<3; i++){ document.image_rotate.src = myimages[number];
	...
	<div class="pull-left">
	<h5>Use This Button to Add Payment Type and Amount
	</h5>
	<h5>
		<form action="" method="post">
			
		<button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">
			Click to Add Payment Type
		</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<input type="text" name="name" class="custominput" id="validationDefault01" placeholder="Payment Type" required>
	   <input type="text" name="amount" class="custominput" id="validationDefault01" placeholder="Amount" required>
	    <select name="classes"  id="inputState" class="custominput">
          <option value="">Select Class</option>
          <?php foreach ($classes as $class): ?>
            <option value="<?php htmlout($class['id']); ?>"<?php
      ...
      <div class="modal-footer">
        ...
        <input class="btn btn-sm btn-success " type="submit" name="action" value="Submit">
            </div>
         </div>
        </form>
       </div>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Action ------------ <a style="text-align:right" href='#'><?php
				 echo count($_SESSION['cart']); ?> Payment(s) Completed
				 </a>  
		</th>
    </tr>
  </thead>
    ...
    <tr>
      ...
      <td> <div class="listuser">
              ...
              <input type="hidden" name="id" value="<?php
                  echo $students['id']; ?>">
				<input class="btn btn-sm btn-success" type="submit" name="action" value="Make Payment">
				<input class="btn btn-sm btn-primary" type="submit" name="action" value="Payment Summary">
				<input class="btn btn-sm btn-danger" type="submit" name="action" value="See Receipt"> 
            </div></td>
